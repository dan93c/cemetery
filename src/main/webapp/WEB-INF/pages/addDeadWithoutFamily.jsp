...
<title>Adauga decedat fara apartinator</title>
</head>
<body>
	<div id="container">
		...
		<div id="center">
			...
			<form:form name="addDeadWithoutFamily"
				modelAttribute="deadWithoutFamily"
				action="${CONTEXT_PATH}/dead2/add" method="POST">
				<s:bind path="*">
				...
				<table class="height-tr">
					...
					<tr>
						...
						<td><form:select path="grave.id" required="required">
