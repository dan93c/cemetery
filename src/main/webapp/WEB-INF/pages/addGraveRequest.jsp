...
<title>Adauga cerere atribuire loc de inhumare</title>
</head>
<body>
	<div id="container">
		...
		<div id="center">
			...
			<form:form name="addGraveRequest" modelAttribute="graveRequest"
				action="${CONTEXT_PATH}/graveRequest/add" method="POST">
				<s:bind path="*">
				...
				<table class="height-tr">
					...
					<tr>
						<td colspan="2" align="left"><input type="submit"
							value="Adauga cerere" class="button medium square blue" /></td>
					</tr>
				</table>
			</form:form>
		</div>
