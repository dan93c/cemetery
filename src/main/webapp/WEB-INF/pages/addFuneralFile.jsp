...
<body>
	<div id="container">
		...
		<div id="center">
			...
			<form:form name="addFuneralFile" modelAttribute="funeralFile"
				action="${CONTEXT_PATH}/funeral/add" method="POST">
				<s:bind path="*">
				...
				<table>
					...
					<tr>
						...
						<td><form:input type="datetime-local" path="funeralDate" pattern="yyyy-MM-dd HH:MM a"></form:input></td>
					...
					<tr>
						<td colspan="2" align="left"><input type="submit"
							value="Programeaza inmormantare"
